...
| `fastq_1`  | Full path to FastQ file for Illumina short reads 1. File can be uncompressed or gzipped, with extension `.fastq`, `.fq`, `.fastq.gz` or `.fq.gz`.                                                                                                                                                                                 |
| `fastq_2`  | Full path to FastQ file for Illumina short reads 2. File can be uncompressed or gzipped, with extension `.fastq`, `.fq`, `.fastq.gz` or `.fq.gz`.                                                                                                                                                                                 |
...
This step can be started either from FastQ files (uncompressed, gzip-compressed or gzip+spring-compressed) or (u)BAMs. The CSV must contain at least the columns `patient`, `sample`, `lane`, and `fastq_1/fastq_2`, `spring_1`, `spring_1/spring_2` or `bam`.
